...
public class QProfileTest {
  ...
  public void to_string() {
    assertThat(new QProfile().setId(1).setName("Default").setLanguage("java").setParent("Parent").toString())
      .contains("[id=1,organizationUuid=<null>,key=<null>,name=Default,language=java,parent=Parent,isDefault=false,rulesUpdatedAt=<null>,lastUsed=<null>,userUpdatedAt=<null>]");
  }
